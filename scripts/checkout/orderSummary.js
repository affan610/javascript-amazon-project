...
export function renderOrderSummary() {
  ...
  cart.cartItems.forEach((cartItem) => {
    ...
    cartSummaryHTML += `
      ...
      matchingProduct.id
    } js-update-button update-quantity-link link-primary">
                                 Update
                                 </span>
                                 <input type="number" class=" quantity-input quantity-input-${
                                   matchingProduct.id
                                 }" ></input>
                                  <span class=" save-quantity-link save-quantity-link-${
                                    matchingProduct.id
                                  } link-primary" >
                                  Save
                                        </span>              
                                    ...
                                    data-product-id=${matchingProduct.id}
                                     class=" js-delete-link-${
                                       matchingProduct.id
                                     } js-delete-link delete-quantity-link link-primary">
                                    Delete
                                    </span>
                              </div>
                          </div>
  ...
  function responseForUpdateButton(productId) {
    ...
    document
      ...
      .classList.add("invisible");
    document
      .querySelector(`.quantity-input-${productId}`)
      .classList.add("visible");
    document
      .querySelector(`.save-quantity-link-${productId}`)
      .classList.add("visible");
  }
